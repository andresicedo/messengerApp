...
import { newChat as newChat$1, TextInput as TextInput$1, Button as Button$1, Dot as Dot$1, Avatar as Avatar$1, isTyping as isTyping$1, sendMessage as sendMessage$1, TextAreaInput as TextAreaInput$1, removePerson as removePerson$1, addPerson as addPerson$1, getOtherPeople as getOtherPeople$1, deleteChat as deleteChat$1, editChat as editChat$1 } from 'react-chat-engine';
import { LoadingOutlined, CloseCircleTwoTone, PaperClipOutlined, CloseOutlined, LeftOutlined, DownOutlined, PlusOutlined, ArrowUpOutlined, DeleteOutlined, UserAddOutlined } from '@ant-design/icons';
...
var ChatList = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderChats = function renderChats(chats) {
    ...
    return chats.map(function (chat, index) {
      ...
      var extraStyle = _this.props.activeChat === chat.id ? styles.activeChat : {};
  ...
  _proto.render = function render() {
    ...
    chats.sort(function (a, b) {
      var aDate = a.last_message.created ? new Date(a.last_message.created) : new Date();
      var bDate = b.last_message.created ? new Date(b.last_message.created) : new Date();
...
var Title = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: styles$1.titleContainer,
      className: "ce-chat-title-container"
    }, /*#__PURE__*/React.createElement("div", {
      style: styles$1.titleText,
      className: "ce-chat-title-text"
    }, chat && chat.title), /*#__PURE__*/React.createElement("div", {
      style: styles$1.subtitleText,
      className: "ce-chat-subtitle-text"
    }, chat.last_message.created && chat.last_message.created.length > 0 && "Active " + timeSinceDate(chat.last_message.created))));
  };
...
var Dot = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: _extends({}, styles$4.dot, customStyle, {
...
var Message = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: _extends({}, styles$5.myMessage, {
        borderRadius: borderRadius
      })
...
var TheirMessage = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: _extends({}, styles$6.theirMessage, {
        borderRadius: borderRadius
      })
    }, message.text))), /*#__PURE__*/React.createElement(Col, {
      xs: 9,
...
var Message$1 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }), message.sender_username === creds.userName ? /*#__PURE__*/React.createElement(Message, {
      chat: chat,
      creds: creds,
...
var MessageForm = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: styles$8.messageFormContainer,
...
var TextInput = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var customStyle = this.props.style ? this.props.style : {};
    var defaultStyle = this.state.focused ? styles$a.focusInput : styles$a.input;
    return (
      /*#__PURE__*/
...
var AutoComplete = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var defaultStyle = _extends({}, styles$c.input, {
...
var Option = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      style: _extends({}, styles$d.option, {
...
var ChatSettings = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, topPeople.length === 1 && this.renderOnePerson(topPeople), topPeople.length === 2 && this.renderTwoPeople(topPeople), topPeople.length === 3 && this.renderThreePeople(topPeople)), /*#__PURE__*/React.createElement(MessageForm$1, {
      chat: chat,
      creds: creds
    }));
  };
...
var ChatSettingsContainer = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var chat = chats && chats[activeChat];
    if (!chat) return /*#__PURE__*/React.createElement("div", {
      style: styles$i.filler
    });
    return /*#__PURE__*/React.createElement("div", {
      style: styles$i.settingsContainer,
...
var Avatar = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "ce-avatar",
      style: _extends({}, styles$j.avatar, customStyle, {
        backgroundColor: this.state.avatar ? 'white' : color,
        backgroundImage: this.state.avatar && "url(" + this.state.avatar + ")",
        backgroundRepeat: 'no-repeat',
        backgroundPosition: 'center',
...
var Button = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var hoverStyle = this.state.hovered ? styles$k.hoverButton : {};
    var themeStyle = theme === 'danger' ? styles$k.dangerButton : styles$k.button;
...
export { Avatar, Button, ChatEngine, ChatFeed, Dot, TextAreaInput, TextInput, addPerson, deleteChat, deleteMessage, editChat, editMessage, editMyData, getChats, getMessages, getMyData, getOtherPeople, isTyping, leaveChat, newChat, removePerson, sendMessage };
