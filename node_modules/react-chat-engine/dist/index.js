...
var Message$1 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }), message.sender_username === creds.userName ? /*#__PURE__*/React__default.createElement(Message, {
      chat: chat,
      creds: creds,
...
var ChatSettings = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, topPeople.length === 1 && this.renderOnePerson(topPeople), topPeople.length === 2 && this.renderTwoPeople(topPeople), topPeople.length === 3 && this.renderThreePeople(topPeople)), /*#__PURE__*/React__default.createElement(MessageForm$1, {
      chat: chat,
      creds: creds
    }));
  };
